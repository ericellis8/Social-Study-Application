<?php
	...
	$result = mysql_query($query);
 	...
 	if(mysql_num_rows($result) > 0){
 		...
 		$insertQuery = "Insert into study_buddy_request(user_id,buddy_id,request_status)VALUES((Select user_id from user where user.user_name = '$myName'), (Select user_id from user where user.user_name = '$user'),0)";
 		$insertResult = mysql_query($insertQuery);
 	}
?>
